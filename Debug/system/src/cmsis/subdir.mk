...
S_UPPER_SRCS += \
../system/src/cmsis/startup_stm32l432xx.S 

OBJS += \
./system/src/cmsis/startup_stm32l432xx.o \
./system/src/cmsis/system_stm32l4xx.o 

S_UPPER_DEPS += \
./system/src/cmsis/startup_stm32l432xx.d 
...
system/src/cmsis/%.o: ../system/src/cmsis/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -O3 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -x assembler-with-cpp -DDEBUG -DTRACE -DSTM32L432xx -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32l4xx" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
